function ReportCriteria()
{
    ...
    this.toString = function()
    {
        ...
        if(mFromDate !== null) result += '&fromDate=' + encodeURIComponent(mFromDate);
        if(mToDate !== null) result += '&toDate=' + encodeURIComponent(mToDate);
        if(mCallsign !== null) result += '&callsign=' + encodeURIComponent(mCallsign);
        if(mIsEmergency == true) result += '&isEmergency=1';
