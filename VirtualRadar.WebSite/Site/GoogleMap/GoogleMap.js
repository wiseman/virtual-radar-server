...
function FatController()
{
    ...
    function filterParameters()
    {
        ...
        if(mOptions.filteringEnabled) {
            ...
            if(mOptions.filterAltitudeLower !== null) result += '&fAltL=' + encodeURIComponent(mOptions.filterAltitudeLower);
            if(mOptions.filterAltitudeUpper !== null) result += '&fAltU=' + encodeURIComponent(mOptions.filterAltitudeUpper);
            if(mOptions.filterDistanceLower !== null) result += '&fDstL=' + encodeURIComponent(mOptions.filterDistanceLower);
            if(mOptions.filterDistanceUpper !== null) result += '&fDstU=' + encodeURIComponent(mOptions.filterDistanceUpper);
            if(mOptions.filterSquawkLower !== null) result += '&fSqkL=' + encodeURIComponent(mOptions.filterSquawkLower);
            if(mOptions.filterSquawkUpper !== null) result += '&fSqkU=' + encodeURIComponent(mOptions.filterSquawkUpper);
            if(mOptions.filterCallsign !== null) result += '&fCall=' + encodeURIComponent(mOptions.filterCallsign);
            if(mOptions.filterOperator !== null) result += '&fOp=' + encodeURIComponent(mOptions.filterOperator);
            if(mOptions.filterRegistration !== null) result += '&fReg=' + encodeURIComponent(mOptions.filterRegistration);
            if(mOptions.filterType !== null) result += '&fTyp=' + encodeURIComponent(mOptions.filterType);
            if(mOptions.filterWtc !== null) result += '&fWtc=' + encodeURIComponent(mOptions.filterWtc);
            if(mOptions.filterSpecies !== null) result += '&fSpc=' + encodeURIComponent(mOptions.filterSpecies);
            if(mOptions.filterEngType !== null) result += '&fEgt=' + encodeURIComponent(mOptions.filterEngType);
            if(mOptions.filterIsMilitary) result += '&fMil=1';
            if(mOptions.filterIsInteresting) result += '&fInt=1';
            if(mOptions.filterCountry !== null) result += '&fCou=' + encodeURIComponent(mOptions.filterCountry);
        }
