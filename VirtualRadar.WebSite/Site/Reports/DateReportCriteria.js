function DateReportCriteria()
{
    ...
    {
        var result = '';
        result += addCriteria('operator', that.getOperator());
        result += addCriteria('reg', that.getRegistration());
        result += addCriteria('icao', that.getIcao());
        result += addCriteria('country', that.getCountry());
        result += addCriteria('wtc', that.getWakeTurbulenceCategory());
        result += addCriteria('species', that.getSpecies());
        if(that.getIsMilitary()) result += addCriteria('isMilitary', '1');
